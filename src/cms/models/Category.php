...
use ant\cms\behaviors\CmsNestedSetsBehavior;
 ...
 */
class Category extends \ant\cms\components\ContentActiveRecord
{
	...
	public function behaviors() {
		return ArrayHelper::merge(parent::behaviors(), [
			['class' => \ant\cms\behaviors\CmsTreeViewModelBehavior::className()],
		]);
	}
